  ...
  return (
    <div className="results-screen">
      ...
      <p className="disclaimer">
        This benchmark assesses reading and listening comprehension only. It does not assess speaking, writing, pronunciation, or fluency. It should not be used as a substitute for a formal ICAO language proficiency assessment.
      </p>
